...
class BookListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewDataBinding = FragmentBooksListBinding.inflate(inflater, container, false).apply {
            viewmodel =
                ViewModelProviders.of(this@BookListFragment).get(BookListViewModel::class.java)
    ...
    private fun setupAdapter() {
        ...
        if (viewModel != null) {
            adapter = BooksListAdapter(activity!!, viewDataBinding.viewmodel!!)
    ...
    private fun setupObservers() {
        viewDataBinding.viewmodel?.bookList?.observe(activity!!, Observer {
